...
// <<< |||
void cpu_mat_mul_new(float* h_A, float* h_B, float* h_C, int height, int dummy, int width);
// >>>

void gpu_mat_mul(float* h_A, float* h_B, float* h_C, int width);
// <<< |||
void gpu_mat_mul_new(float* h_A, float* h_B, float* h_c, int height, int dummy, int width);
// >>>
